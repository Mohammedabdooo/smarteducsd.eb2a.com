...
$langVersion = "النسخة";
$langAboutText = "نسخة المنصة هي";
$langHostName = "اسم المضيف هو";
$langMySqlVersion = "نسخة قاعدة البيانات";
$langNoMysql = "MySql is down!";
$langUptime = "منصة تعلم منذ";
$langTotalHits = "اجمالي عدد هذا";
$langLast30daysLogins = 'اجمالي عدد عمليات التسجيل بالمنصة خلال اخر 30 يوم';
$langTotalCourses = "عدد الدورات";
$langInfo = "نيذة عن";
$langAboutCourses = 'النظام الاساسي يدعم في المجموع';
$langOperation = "عملية";
$langAnd = "و";
$langCoursesHeader = "الدورات";
$langClosed = "مغلق";
$langOpen = "مفتوح";
$langSemiopen = "تتطلب التسجيل";
$langUsers = "المستخدمون";
$langUsersS = "المستخدمون";
$langUser = "المستخدم";
$langUserHeader = "المستخدم:";
$langUserS = "المستخدم";
$langSupportUser = "الدعم:";
$langAdminUsers = "ادارة المستخدمون";
$langDeleteAdmin = "حذف المسوؤل عن طريق id:";
$langNotFeasible = "غير ممكن";
$langPassword = "كلمة السر";
$langAdd = "اضيف";
$langNotFound = "غير موجود";
$langWith = "مع";
$langDone = "يصبح مشرف.";
...
$langInsertUserInfo = "ادخال بيانات المستخدم";
$langPage = "الصفة:";
$langBeforePage = "السابق";
$langAfterPage = "التالي";
$langComments = "التعليقات";
$langAdmin = "ادوات مسوؤل النظام";
$langState = "مدير السيرفر";
$langDevAdmin = "مدير البيانات";
$langSysInfo = "معلومات النظام";
$langCheckDatabase = "تحقق من قاعدة الببانات الرئيسية";
$langStatOf = "احصائيات ل";
$langSpeeSubscribe = "التسجيل كمسؤول للدورة";
$langLogIdentLogout = "سجل تسجيلات الدخول والخروج";
$langPlatformStats = "احصائيات المنصة";
$langPlatformGenStats = "احصائيات عامة";
$langVisitsStats = "احصائيات الزوار";
$langMonthlyReport = "التقارير الشهرية";
$langReport = " التقرير الشهري";
$langNoReport = "لا يوجد بيانات نشطة لهذا الشهر";
$langEmailNotSend = "خطا : غير قادر على الارسال الى";
$langFound = "موجود";
$langFoundIt = "موجود";
$langListCours = "الدورة/اجراءات الدورة";
$langListUsersActions = "قائمة المستخدمين / الاجراءات";
$langSearchUser = "بحث المستخم";
$langInfoMail = "معلومات البريد";
$langProfReg = "$langOfTeacher التسجيل";
$langProfOpen = "$langOfTeacher طلبات مفتوحة";
$langUserOpen = "$langOfStudents طلبات مفتوحة";
$langPHPInfo = "معلومات php";
$langManuals = "التوجيهات";
$langFormatPDF = "PDF تنسيق";
$langFormatHTML = "HTML تنسيق";
$langAdminManual = "Admin's Manual";
$langDBaseAdmin = "Database management (phpMyAdmin)";
$langActions = "الاجراءات";
$langAdminProf = "$langTeachers المسوؤل";
$langAdminCours = "مسوؤل الدورة";
$langGenAdmin = "ادوات اخرى";
$langBackAdmin = "رجوع الى صفحة المسوؤل";
$langPlatformIdentity = "نبذة عن";
$langStoixeia = "معلومات المنصة";
$langThereAre = "يوجد هنالك";
$langThereIs = "يوجد هنالك";
$langOpenRequests = "$langOfTeachers طلبات مفتوحة";
$langNoOpenRequests = "لا يوجد طلبات مفتوحة للمعلمين";
$langInfoAdmin = "معلومات للمسوؤل";
$langLastLesson = "اخر دورة :";
$langLastProf = "اخر ".$langsOfTeacher." تسجيل:";
$langLastStud = "اخر مستخدم مسجل :";
$langAfterLastLogin = "بعد اخر تسجيل دخول لك, :";
$langAfterLastLoginInfo = "البيانات بعد اخر تسجيل:";
$langOtherActions = "اجراءات اخرى";
$langNbProf = "عدد ".$langsTeachers."";
$langNbStudents = "عدد ".$langsStudents."";
$langNbLogin = "عدد المسجلين";
$langNbCourses = "عدد الدورات";
$langNbVisitors = "عدد الزوار";
$langToday = "اليوم";
$langLast7Days = "اخر 7 ايام";
$langLast30Days = "اخر 30 يوم";
$langNbAnnoucement = "عددالاعلانات";
$langNbUsers = "عدد المستخدمين";
$langCoursVisible = "مرئي";
$langOthers = "مجموعات اخرى";
$langErrors = "الاخطاء:";
$langMultEmail = "عروض متعددة لعناوين البريد الالكتروني";
$langMultLoginPass = "تسجيل الدخول المتعدد - تمرير ازواج";
$langOk = "حسنا";
$langCont = "استمرار";
$langNumUsers = "عدد المشاركين في المنصة";
$langNumGuest = "عدد الضيوف";
$langRestoreCourse = "استرجاع الدورة";
$langStatCour = "احصائيات الدورة";
$langNumCourses = "عدد الدورات";
$langNumEachCourse = "دورات لكل كلية";
$langNumEachLang = "دورات لكل لغة";
$langNunEachAccess = "دورات لكل نوع وصول";
$langNumEachCat = "دورات لكل نوع وصول";
$langAnnouncements = "اعلانات";
$langFrom = "من";
$langFrom2 = "من";
$langNotExist = "غير موجود!";
$langExist = "موجود!";
$langResult = "النتيجة";
$langMultiplePairs = "ازواج متعددة";
$langMultipleAddr = "حالات متعددة للعنوان";
$langMultipleUsers = "سجلات مستخدم متعددة";
$langAlert = "نقاط الملاحظات";
$langServerStatus = "حالة سيرفر قاعدة البيانات : ";
$langDataBase = "قاعدة البيانات";
$langLanguage = "اللغة";
$langUpgradeBase = "تحديث البيانات";
$langCleanUp = 'المضي قدما في تنظيف';
$langUpdatingStatistics = "تحديث الاحصائيات الشهرية";
$langPleaseWait = "انتظر من فضلك";
$langBegin = "بداية";
$langEnd = "نهاية";
$langPreced50 = "السابق";
$langFollow50 = "التلي";
$langAll = "الكل";
$langNoSuchUsers = "ليس هنالك مستخدمون بهذة المعايير";
$langAsInactive = "كغير نشط";
$langOpenCourse = "مفتوح";
$langClosedCourse = "مغلق";
$langRegCourse = "التسجيل مطلوب";
$langQuotaAdmin = "ادارة مساحة القرص المتاحة(اقتباس)";
$langQuotaSuccess = "اقنباس تعديل ناجح";
$langQuotaFail = "فشل الاقتباس!";
$langMaxQuota = "الحدالاقصى";
$langLegend = "";
$langVideo = "الوسائط المتعددة";
$langReturnToSearch = "عودة الى نتائج البحث";
$langReturnSearch = "عودة للبحث";
$langNoChangeHappened = "No change performed!";
$langManyExist = "There are";
$langReturnToAddFaculte = "عودة للاضافة $langOfFaculty";
$langReturnToEditFaculte = "عودة لتعديل $langOfFaculty التفاصيل";
$langFaculteAdd = "اضف $langOfFaculty";
$langFaculteDel = "حذف $langOfFaculty";
$langFaculteEdit = "تعديل $langOfFaculty التفاصيل";
$langFaculteIns = "ادراج جديد $langOfFaculty التفاصيل";
$langAcceptChanges = "تأكيد التغييرات";
$langEditFacSucces = "$langOfFaculty اكتمل التعديل بتجاح!";
$langFormUserManage = "نموذج ادارة المستخدم";
$langListNotRegisteredUsers = "قائمة المسخدمين غير المسجلين";
$langListRegisteredStudents = "المسجلين ".$langStudents." قائمة";
$langListRegisteredProfessors = "المسجلين ".$langTeachers." قائمة";
$langErrChoose = "حدث خطأ في اختيار الدورة!";
$langCourseDel = "حذف الدورة";
$langCourseDelSuccess = "تم ذحف الدورة بنجاح!";
$langCourseDelConfirm = "تأكيد حذف الدورة";
$langCourseDelConfirm2 = "هل انت متأكد انك تريد حذف الدورة مع الكود";
$langNoticeDel = "ملاحظة: حذف الدورة وايضا الملتحقين  ".$langsOfStudentss."
 من هذة الدورة, along with course faculty correspondence and course material.";
$langCourseEdit = "تعديل الدورة";
$langCourseInfo = "الاعدادات";
$langQuota = "اقتباس الدورة";
$langCourseStatus = "حالة الكورس";
$langCurrentStatus = "الوضع الحالي";
$langListUsers = "قائمة المستخدمين";
$langTakeBackup = "رجوع";
$langStatsCourse = "احصائيات الدورة";
$langCourseEditSuccess = "تم تحديث اعدادات الدورة";
$langCourseInfoEdit = "تعديل معلومات الدورة";
$langBackCourse = "الرجوع الى صفحة الدورة";
$langOpenProfessorRequests = "$langTeachers طلبات مفتوحة";
$langProfessorRequestClosed = "".$langTeacher." طلب مغلق!";
$langReqHaveClosed = "طلبات مغلقة";
$langReqHaveBlocked = "رفض الطلب";
$langReqHaveFinished = "طلبات مكتملة";
$langemailsubjectBlocked = "رفض طلب التسجيل";
$langemailbodyBlocked = "تم رفض طلب التسجيل.";
$langCloseConf = "تأكيد طلب الاغلاق";
$langReintroductionApplication = "تم الانتهاء من استرجاع التطبيق بنجاح";
$langBackRequests = "الرجوع الى قائمة الطلبات";
$langSendMessageTo = "ارسال ايميل";
$langToAllUsers = "الى كا المستخدمين";
$langProfOnly = "الى ".$langsTeachers."";
$langSearchCourse = "البحث عن الدورات";
$langNewSearch = "بحث جديد";
$langSearchCriteria = "معايير البحث";
$langSearch = "بحث";
$langCourseStatusChangedSuccess = "تم تغيير نوع الوصول للدورة بنجاح!";
$langCourseStatusChange = "تغيير نوع الوصول للدورة";
$langMethods = "وضع المصادقة النشطة:";
$langActivate = "تفعيل";
$langDeactivate = "الغاء التفعيل";
$langChooseAuthMethod = "حدد طريقة مصادقة المستخدم وتحديد اعداداتها";
$langConnYes = "تم الاتصال بنجاح!";
$langConnNo = "الاتصال لا يعمل بصورة صحيحة!";
...
$langChangeUser = 'التسجيل كمستخدم اخر';
$langChangeUserNotFound = 'الحساب مع اسم المستخدم  "%s" غير موجود';
$langMultiRegUser = 'Bulk user account creation';
$langMultiRegUserInfo = "<p>Please enter in the area below a list of user details,
 one line per each new user account.</p>
...
$langMultiRegCourseInvalid = 'المستخدم %s: invalid course code "%s"';
$langMultiRegFields = 'Fields/Field order definition';
$langMultiRegFieldError = 'خطأ! Invalid field label:';
$langMultiRegType = 'نوع الحساب';
$langMultiRegSendMail = 'معلومات البريد لحساب المستخدم';
$langMultiRegPrefix = 'بادئة اسم المستخدم';
$langSearchCourses = "بحث الدورات";
$langActSuccess = "يجب تنشيط ال ";
$langDeactSuccess = " يجب عدم تنشيط ال";
$langThe = "ال ";
$langActFailure = "cannot be activated, because no authentication settings have been defined";
$langLdapNotWork = "تحذير: The PHP does not support ldap. Please make sure the ldap support 
...
$langProperty = "تحضير";
$langStat = "الخصائص";
$langNoUserList = "لا يوجد نتائج بحث";
$langContactAdmin = 'لمزيد من المعلومات, اتصل بمدير المنصة.';
$langActivateAccount = "من فضلك نشط حسابي";
$langLessonCode = "كلمة السر الخاصة بالدورة";
$langConfirmDelete = "تأكيد الحذف";
$langConfirmDeleteQuestion1 = "هل انت متأكيد انك تريد حذف المستخدم";
$langConfirmDeleteQuestion2 = "من الدورة مع المعرف(id) ";
$langTryDeleteAdmin = "You have tried to delete the user with user id = 1 (Admin)!";
$langWasDeleted = "تم الحذف";
$langWasAdmin = "كان المسؤول";
$langWasCourseDeleted = "تم الحذف من الدورة";
$langErrorDelete = "خطأ اثنا الحذف";
$langAfter = "بعد";
$langBefore = "قبل";
$langUserType = "نوع المستخدم";
$langSearchUsers = "بحث عن المستخدمين";
$langInactiveUsers = "مستخدمين غير نشطين";
$langAddSixMonths = "اعادة تنشيط الحساب";
$langRestoredValues = "استرجاع القيمة القديمة";
$langEclassConf = "ملف التكوين";
$langFileUpdatedSuccess = "تم تحديث تكوين المنصة.";
...
$langAdminAnnMes = "اعلن في";
$langAdminAnnTitleEn = "عنوان";
$langAdminAnnBodyEn = "اعلان";
$langAdminAnnCommEn = "تعليقات";
$langCleanupOldFiles = 'تنظيف الملفات القديمة';
$langCleaningUp = 'تنظيف الملفات الاقدم من %s %s من %s الدليل ';
$langDaySing = 'يوم';
$langDayPlur = 'ايام';
...
$langCleanup = 'تنظيف';
$langModify = "تعديل";
$langAddModify = "اضف / تعديل";
$langAddIntro = "اضافة النص التمهيدي";
$langBackList = "رجوع الى القائمة";
$langEvents = "الاحداث";
$langAgenda = "جدول الاعمال";
$langDay = "يوم";
$langMonth = "شهر";
$langYear = "سنة";
$langHour = 'ساعة';
...
$langhours = 'ساعات';
$langDateNow = "اليوم:";
$langCalendar = "التقويم";
$langAddEvent = "اضافة حدث";
$langDetail = "التفاصيل";
$langChooseDate = "اختيار تاريخ";
$langOldToNew = "الاقدم اولا";
$langStoredOK = "تم حفظ الحدث";
$langDeleteOK = "تم حذف الحدث";
$langNoEvents = "لا يوجد احداث";
$langSureToDel = "هل حقا تريد حذف عنوان الحدث";
$langDelete = "حذف";
$langInHour = "(في ساعة)";
$langEmptyAgendaTitle = "من فضلك نوع عنوان جدول الاعمال";
$langAgendaNoTitle = "جدول اعمال من غير عنوان";
...
$langOn = "من";
$langRegUser = "مستخدمين مسجلين بالدورة";
$langModifAnn = "تعديل هذا الاعلان";
$langAnnouncement = "اعلان";
$langMove = "التحرك";
$langAnnModify = "تم تعديل الاعلان";
$langAnnAdd = "تم اضافة الاعلان";
$langAnnDel = "تم حذف الاعلان";
$langPubl = "نشرت على";
$langAddAnn = "اضافة اعلان";
$langContent = "المحتوى";
$langAnnTitle = "عنوان الاعلان";
$langAnnBody = "جسم الاعلان";
$langEmptyAnn = "حذف قائمة الاعلانات";
$professorMessage = "$langTeacher رسالة";
$langEmailSent = "وارسالها بالبريد الى المسجلين ".$langsStudents."";
$langEmailOption = "ارسال اعلان (via email) الى المسجلين ".$langsStudents."";
$langUp = "اعلى";
$langDown = "اسفل";
$langNoAnnounce = "ليس هناك اعلانات";
$langSureToDelAnnounce = "هل انت مأكد انك تريد حذف هذا الاعلان";
$langSureToDelAnnounceAll = "هل انت مأكد انك تريد حذف جميع الاعلان";
$langAnn = "اعلن على";
$langEmptyAnTitle = "من فضلك عنوان نوع الاعلان";
$langAnnouncementNoTille = "اعلان من غير عنوان";
$langArchiveCourse = "ارجاع ملف الدورة";
$langCreatedIn = "تم الاضافة في";
$langCreateDirMainBase = "انشاء دليل لاستعادة قاعدة البيانات الرئيسية";
$langCreateDirCourseBase = "Creation of directory for restoring courses databases";
$langCopyDirectoryCourse = "نسخ ملمات الدورة";
$langDisk_free_space = "مساخة القرص المتاحة";
$langBuildTheCompressedFile = "انشاء نسخة احتياطية من الملف";
$langFileCopied = "تم النسخ";
...
$langText = "نص";
$langCheckGrades =' تحقق من الدرجات';
$langCheckGradesConsistent = 'Checking grades for inconsistencies';
$langCheckFinished = 'انتهى التحقق.';
...
$langExerciseAttemptsUnlimited = 'غير محدود';
